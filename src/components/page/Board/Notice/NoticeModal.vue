...
const searchDetail = () => {
    axios.post('/api/board/noticeDetailBody.do',{noticeSeq: props.idx }).then((res) => {
        ...
        if(noticeDetail.value.fileExt === 'jpg' || noticeDetail.value.fileExt === 'gif' || noticeDetail.value.fileExt === 'png' || noticeDetail.value.fileExt === 'webp'){
            getFileImage();
        }
    });
};
...
const handlerFile = (e) => {
    ...
    if(fileExtension === 'jpg' || fileExtension === 'gif' || fileExtension === 'png' || noticeDetail.value.fileExt === 'webp'){
